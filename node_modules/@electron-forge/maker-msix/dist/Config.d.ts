import { ManifestGenerationVariables, PackagingOptions as MSIXPackagingOptions } from 'electron-windows-msix';
 ...
 */
export type MakerMSIXConfig = Omit<MSIXPackagingOptions, 'outputDir' | 'appDir' | 'manifestVariables'> & {
